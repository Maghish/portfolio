...
export default function ExperienceModal({
  ...
  return (
    <div className="absolute top-0 left-0 min-w-full min-h-full overflow-auto bg-white bg-opacity-5 backdrop-blur-lg flex justify-center items-center animate-fade-in-scale">
      <div className="relative bg-black bg-opacity-50 backdrop-blur-xl rounded-lg w-[350px] h-[350px] border-white border-opacity-30 border-2 px-6 py-8 flex flex-col items-center justify-between">
